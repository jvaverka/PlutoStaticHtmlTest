...
MethodInstance for Main.var\"workspace#4\".double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.var\"workspace#4\" at /home/runner/work/PlutoStaticHtmlTest/PlutoStaticHtmlTest/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):   42.180 ns …  20.251 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      45.106 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   114.389 ns ± 890.029 ns  ┊ GC (mean ± σ):  0.53% ± 1.67%

     ▃█▄▂ ▂                                                      
  ▃▃▇██████▆▄▄▄▄▄▄▄▃▃▃▃▃▃▃▄▅▆▆▇▆▅▅▄▃▃▃▃▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▁▂▂▁▂ ▃
  42.2 ns          Histogram: frequency by time         62.2 ns <
...
BenchmarkTools.Trial: 10000 samples with 997 evaluations.
 Range (min … max):  22.267 ns …  24.128 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     24.273 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   71.654 ns ± 795.014 ns  ┊ GC (mean ± σ):  2.12% ± 1.70%

     ▄▅▇█▇▆▆▆▅▃▁     ▁▂▂▂▂▁▂▁▁ ▁▁▁ ▁   ▂▃▄▄▄▅▄▄▄▃▃▃▂▂▁▁        ▂
  ▇▇█████████████▇▇▇████████████████████████████████████▇▇▇▅▆▆ █
  22.3 ns       Histogram: log(frequency) by time      34.7 ns <
